            ...
            <div className="card-block">
              <div className="row" id="sortable">
                ...
                <div className="col-md-6  m-b-20" style={{textAlign:"center", justifyContent:"center"}}>
                  ...
                  {caseObj!==null && !caseObj.markAsDone && <div className="card-block">
                      <button style={{margin:"150px 50px 10px 50px"}} className='GenerateReport' onClick={() =>togglePopupReport()}>Generate Report</button><br/>
                      <button style={{margin:"5px 50px 135px 50px"}} className='MarkDone' onClick={() => markAndCloseCase()}>Mark as Done</button>
                    </div>}
                    {caseObj!==null && caseObj.markAsDone && <div className="card-block">
                      <button style={{margin:"150px 50px 10px 50px"}} className='GenerateReport' onClick={() =>generateReportRadiologistImpression()}>View Radiologist Impression</button><br/>
                      <button style={{margin:"5px 50px 135px 50px", visibility:'hidden'}} className='MarkDone' onClick={() => markAndCloseCase()}>Mark as Done</button>
                    </div>}
                  </div>
                </div>
              </div>
